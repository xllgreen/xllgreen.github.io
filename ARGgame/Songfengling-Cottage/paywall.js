...
const Paywall = {
  STORAGE_KEY: '_songfengling_cabin_support',
  SESSION_KEY: '_songfengling_cabin_session',
  COOKIE_KEY: '_songfengling_pay_flag',
  ...
  _generateToken() {
    ...
    const sig = btoa(`${ts}_${rand}_songfengling_cabin`);
    return sig;
  },
  ...
  _showThanks() {
    ...
    toast.innerHTML = '感谢你的支持！松峰岭的灯继续亮着。';
            ...
            <div class="paywall-body">
              ...
              <div class="paywall-message">
                ...
                <p class="paywall-msg-body">
                  这部作品把解谜、历史记忆和人物承诺放在一间小屋里慢慢展开。<br>
                  如果你在整理遗物的过程中感受到了一点触动，愿意支持 <strong>1元</strong>，<br>
                  那将帮助我继续做这种安静但用心的网页叙事游戏。
                </p>
                <p class="paywall-msg-cute">
                  1块钱不多，却能让这盏小小的创作煤油灯再亮一会儿。
                </p>
                <p class="paywall-msg-warm2">
                  感谢每一位愿意支持独立创作、也愿意认真读完一个故事的你。
                </p>
              </div>
            </div>
