...
['shen-jiang-ye-an.html','style.css','app.js','paywall.css','paywall.js','paycode.png'].forEach(need);
const read=f=>fs.readFileSync(path.join(ROOT,f),'utf8');
if(fail.length){console.error('RELEASE_CHECK_FAIL',fail.join(' | '));process.exit(1)}
const html=read('shen-jiang-ye-an.html'),app=read('app.js'),pay=read('paywall.js');
const checks=[
